...
import { ShoppingCart, Loader2, AlertCircle, Target, Shield, TrendingUp, DollarSign, Activity, Search } from "lucide-react";
          ...
          <Field label="Symbol">
            <div className="relative">
              <div className="flex items-center gap-1.5 rounded-md border border-border bg-surface-elevated px-2">
                ...
                <input
                  type="text"
                  value={symbolDropdownOpen ? symbolQuery : symbol.replace("USDT", "/USDT")}
...
function RightColumn({
  ...
  return (
    <div className="flex min-h-0 flex-col gap-2">
      ...
      <ExtremeAlerts mode="spot" onSelect={onSelectSymbol} />
